 ...
 * @author trigueros
 */
public class ProcessInvitationRequest extends HttpServlet
{
        ...
        throws ServletException, IOException
    {
        ...
        try
        {
            AddUserToInvitationMessage addUserInvitation = new AddUserToInvitationMessage();
            /** HACK: This section is hardcoded it must changed!! */
            addUserInvitation.setVMURL("192.168.239.247");
            addUserInvitation.setPortNumber(1337);
            /** HACK */
